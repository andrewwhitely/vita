    ...
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      ...
      <div className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        ...
        <div className="flex flex-wrap items-center justify-around max-w-4xl mt-6 sm:w-full">
          <a href="/about" className="p-6 mt-6 text-left border w-96 rounded-xl hover:border-purple-600 hover:text-purple-600 focus:text-purple-600">
            <h3 className="text-2xl font-bold">about</h3>
            <p className="mt-4 text-xl">get to know me &rarr;</p>
          </a>

          <a href="/projects" className="p-6 mt-6 text-left border w-96 rounded-xl hover:border-purple-600 hover:text-purple-600 focus:text-purple-600">
