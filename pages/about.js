    ...
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      ...
      <div className="flex flex-col items-center justify-center w-full flex-1 px-20 text-center">
        ...
        <div className="flex flex-wrap items-center justify-around max-w-4xl mt-6 sm:w-full space-y-4">
          <p>i'm andrew whitely - a fullstack software engineer currently working at <a className='text-purple-600' href='https://capitalone.com/' target='_blank' rel='noopener noreferrer'>Capital One</a> with a focus in web development. outside of work, i'm busy exploring blockchain and web3 technologies and navigating the crypto space through nfts.</p>
          <p>you can view other things i've worked on under my <a className='text-purple-700' href='/projects'>projects</a> page.</p>
        </div>
